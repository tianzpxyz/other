...
curl -fsSL  https://raw.githubusercontent.com/tianzpxyz/other/master/patch/poweroff/poweroff.htm > ./feeds/luci/modules/luci-mod-admin-full/luasrc/view/admin_system/poweroff.htm 
curl -fsSL  https://raw.githubusercontent.com/tianzpxyz/other/master/patch/poweroff/system.lua > ./feeds/luci/modules/luci-mod-admin-full/luasrc/controller/admin/system.lua
curl -fsSL  https://raw.githubusercontent.com/tianzpxyz/other/master/patch/default-settings/zzz-default-settings > ./package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/家庭云/云盘/g' package/lean/luci-app-familycloud/luasrc/controller/familycloud.lua
...
svn co https://github.com/tianzpxyz/mypackages/trunk/luci-theme-opentomcat ./package/lean/luci-theme-opentomcat
